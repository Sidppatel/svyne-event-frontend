...
/**
 * @generated from protobuf service svyne.enums.EnumService
 */
export interface IEnumServiceClient {
    /**
     * @generated from protobuf rpc: ListEnums(svyne.enums.ListEnumsRequest) returns (svyne.enums.ListEnumsResponse);
     */
