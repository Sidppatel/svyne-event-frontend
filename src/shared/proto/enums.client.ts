...
/**
 * @generated from protobuf service ticketspan.enums.EnumService
 */
export interface IEnumServiceClient {
    /**
     * @generated from protobuf rpc: ListEnums(ticketspan.enums.ListEnumsRequest) returns (ticketspan.enums.ListEnumsResponse);
     */
