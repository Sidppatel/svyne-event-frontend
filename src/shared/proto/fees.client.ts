...
/**
 * @generated from protobuf service svyne.fees.FeeService
 */
export interface IFeeServiceClient {
    /**
     * Read: any authenticated user (tenants pick a formula; UIs display it).
     *
     * @generated from protobuf rpc: ListFeeFormulas(svyne.common.Empty) returns (svyne.fees.ListFeeFormulasResponse);
     */
    listFeeFormulas(input: Empty, options?: RpcOptions): UnaryCall<Empty, ListFeeFormulasResponse>;
    /**
     * Write: developer only.
     *
     * @generated from protobuf rpc: CreateFeeFormula(svyne.fees.FeeFormulaInput) returns (svyne.common.UuidValue);
     */
    createFeeFormula(input: FeeFormulaInput, options?: RpcOptions): UnaryCall<FeeFormulaInput, UuidValue>;
    /**
     * @generated from protobuf rpc: UpdateFeeFormula(svyne.fees.FeeFormula) returns (svyne.common.AckResponse);
     */
    updateFeeFormula(input: FeeFormula, options?: RpcOptions): UnaryCall<FeeFormula, AckResponse>;
    /**
     * @generated from protobuf rpc: DeleteFeeFormula(svyne.common.UuidValue) returns (svyne.common.AckResponse);
     */
     ...
     *
     * @generated from protobuf rpc: ListAllEvents(svyne.common.Empty) returns (svyne.fees.DeveloperEventsResponse);
     */
     ...
     *
     * @generated from protobuf rpc: AssignFeeFormula(svyne.fees.AssignFeeFormulaRequest) returns (svyne.common.AckResponse);
     */
