...
export interface IDeveloperBillingServiceClient {
    /**
     * @generated from protobuf rpc: ListTenantBilling(ticketspan.common.PageRequest) returns (ticketspan.billing.TenantBillingList);
     */
    listTenantBilling(input: PageRequest, options?: RpcOptions): UnaryCall<PageRequest, TenantBillingList>;
    /**
     * @generated from protobuf rpc: StartTrial(ticketspan.billing.TenantRequest) returns (ticketspan.common.AckResponse);
     */
    startTrial(input: TenantRequest, options?: RpcOptions): UnaryCall<TenantRequest, AckResponse>;
    /**
     * @generated from protobuf rpc: CreateSubscription(ticketspan.billing.SubscriptionRequest) returns (ticketspan.common.AckResponse);
     */
    createSubscription(input: SubscriptionRequest, options?: RpcOptions): UnaryCall<SubscriptionRequest, AckResponse>;
    /**
     * @generated from protobuf rpc: ChangeSubscriptionTier(ticketspan.billing.SubscriptionRequest) returns (ticketspan.common.AckResponse);
     */
    changeSubscriptionTier(input: SubscriptionRequest, options?: RpcOptions): UnaryCall<SubscriptionRequest, AckResponse>;
    /**
     * @generated from protobuf rpc: CancelSubscription(ticketspan.billing.CancelSubscriptionRequest) returns (ticketspan.common.AckResponse);
     */
    cancelSubscription(input: CancelSubscriptionRequest, options?: RpcOptions): UnaryCall<CancelSubscriptionRequest, AckResponse>;
    /**
     * @generated from protobuf rpc: ListEventUpgrades(ticketspan.common.PageRequest) returns (ticketspan.billing.EventUpgradeList);
     */
    listEventUpgrades(input: PageRequest, options?: RpcOptions): UnaryCall<PageRequest, EventUpgradeList>;
    /**
     * @generated from protobuf rpc: ActivateEventUpgrade(ticketspan.billing.EventUpgradeRequest) returns (ticketspan.common.AckResponse);
     */
    activateEventUpgrade(input: EventUpgradeRequest, options?: RpcOptions): UnaryCall<EventUpgradeRequest, AckResponse>;
    /**
     * @generated from protobuf rpc: CancelEventUpgrade(ticketspan.billing.CancelEventUpgradeRequest) returns (ticketspan.common.AckResponse);
     */
    cancelEventUpgrade(input: CancelEventUpgradeRequest, options?: RpcOptions): UnaryCall<CancelEventUpgradeRequest, AckResponse>;
    /**
     * @generated from protobuf rpc: ListTenantAddons(ticketspan.billing.TenantRequest) returns (ticketspan.billing.TenantAddonList);
     */
    listTenantAddons(input: TenantRequest, options?: RpcOptions): UnaryCall<TenantRequest, TenantAddonList>;
    /**
     * @generated from protobuf rpc: ProvisionAddon(ticketspan.billing.ProvisionAddonRequest) returns (ticketspan.common.AckResponse);
     */
    provisionAddon(input: ProvisionAddonRequest, options?: RpcOptions): UnaryCall<ProvisionAddonRequest, AckResponse>;
    /**
     * @generated from protobuf rpc: CancelAddon(ticketspan.billing.CancelAddonRequest) returns (ticketspan.common.AckResponse);
     */
    cancelAddon(input: CancelAddonRequest, options?: RpcOptions): UnaryCall<CancelAddonRequest, AckResponse>;
    /**
     * @generated from protobuf rpc: ListFeeOverrides(ticketspan.common.Empty) returns (ticketspan.billing.FeeOverrideList);
     */
    listFeeOverrides(input: Empty, options?: RpcOptions): UnaryCall<Empty, FeeOverrideList>;
    /**
     * @generated from protobuf rpc: SetEventFeeOverride(ticketspan.billing.SetEventFeeOverrideRequest) returns (ticketspan.common.AckResponse);
     */
    setEventFeeOverride(input: SetEventFeeOverrideRequest, options?: RpcOptions): UnaryCall<SetEventFeeOverrideRequest, AckResponse>;
    /**
     * @generated from protobuf rpc: ClearEventFeeOverride(ticketspan.billing.ClearEventFeeOverrideRequest) returns (ticketspan.common.AckResponse);
     */
    ...
    /**
     * @generated from protobuf rpc: GetRevenueReport(ticketspan.billing.RevenueReportRequest) returns (ticketspan.billing.RevenueReport);
     */
    getRevenueReport(input: RevenueReportRequest, options?: RpcOptions): UnaryCall<RevenueReportRequest, RevenueReport>;
    /**
     * @generated from protobuf rpc: GetTenantActivity(ticketspan.billing.TenantActivityRequest) returns (ticketspan.billing.TenantActivityList);
     */
    getTenantActivity(input: TenantActivityRequest, options?: RpcOptions): UnaryCall<TenantActivityRequest, TenantActivityList>;
    /**
     * @generated from protobuf rpc: GetTaxReport(ticketspan.billing.RevenueReportRequest) returns (ticketspan.billing.TaxReport);
     */
    ...
    /**
     * @generated from protobuf rpc: GetTenantDashboard(ticketspan.billing.TenantRequest) returns (ticketspan.billing.TenantDashboard);
     */
    getTenantDashboard(input: TenantRequest, options?: RpcOptions): UnaryCall<TenantRequest, TenantDashboard>;
    /**
     * @generated from protobuf rpc: ListTaxOverrides(ticketspan.common.Empty) returns (ticketspan.billing.TaxOverrideList);
     */
    listTaxOverrides(input: Empty, options?: RpcOptions): UnaryCall<Empty, TaxOverrideList>;
    /**
     * @generated from protobuf rpc: SetEventTaxOverride(ticketspan.billing.SetEventTaxOverrideRequest) returns (ticketspan.common.AckResponse);
     */
    setEventTaxOverride(input: SetEventTaxOverrideRequest, options?: RpcOptions): UnaryCall<SetEventTaxOverrideRequest, AckResponse>;
    /**
     * @generated from protobuf rpc: ClearEventTaxOverride(ticketspan.billing.ClearEventFeeOverrideRequest) returns (ticketspan.common.AckResponse);
     */
    ...
    /**
     * @generated from protobuf rpc: ListTaxRates(ticketspan.common.Empty) returns (ticketspan.billing.TaxRateList);
     */
    listTaxRates(input: Empty, options?: RpcOptions): UnaryCall<Empty, TaxRateList>;
    /**
     * @generated from protobuf rpc: LookupTaxRate(ticketspan.billing.TaxRateLookupRequest) returns (ticketspan.billing.TaxRateRow);
     */
    lookupTaxRate(input: TaxRateLookupRequest, options?: RpcOptions): UnaryCall<TaxRateLookupRequest, TaxRateRow>;
    /**
     * @generated from protobuf rpc: RefreshAllTaxRates(ticketspan.common.Empty) returns (ticketspan.common.AckResponse);
     */
    refreshAllTaxRates(input: Empty, options?: RpcOptions): UnaryCall<Empty, AckResponse>;
    /**
     * @generated from protobuf rpc: ListVenueTaxSummaries(ticketspan.common.Empty) returns (ticketspan.billing.VenueTaxSummaryList);
     */
