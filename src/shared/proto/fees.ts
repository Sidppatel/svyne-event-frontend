...
// @generated from protobuf file "fees.proto" (package "svyne.fees", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message svyne.fees.FeeFormula
 */
...
/**
 * @generated from protobuf message svyne.fees.FeeFormulaInput
 */
...
/**
 * @generated from protobuf message svyne.fees.ListFeeFormulasResponse
 */
export interface ListFeeFormulasResponse {
    /**
     * @generated from protobuf field: repeated svyne.fees.FeeFormula formulas = 1;
     */
    formulas: FeeFormula[];
}
/**
 ...
 *
 * @generated from protobuf message svyne.fees.FeeLineItem
 */
...
/**
 * @generated from protobuf message svyne.fees.DeveloperEvent
 */
export interface DeveloperEvent {
    ...
    status: string;
    /**
     * @generated from protobuf field: repeated svyne.fees.FeeLineItem items = 6;
     */
    items: FeeLineItem[];
}
/**
 * @generated from protobuf message svyne.fees.DeveloperEventsResponse
 */
export interface DeveloperEventsResponse {
    /**
     * @generated from protobuf field: repeated svyne.fees.DeveloperEvent events = 1;
     */
    events: DeveloperEvent[];
}
/**
 * @generated from protobuf message svyne.fees.AssignFeeFormulaRequest
 */
...
/**
 * @generated MessageType for protobuf message svyne.fees.FeeFormula
 */
...
/**
 * @generated MessageType for protobuf message svyne.fees.FeeFormulaInput
 */
...
class ListFeeFormulasResponse$Type extends MessageType<ListFeeFormulasResponse> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ListFeeFormulasResponse): ListFeeFormulasResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated svyne.fees.FeeFormula formulas */ 1:
    ...
    internalBinaryWrite(message: ListFeeFormulasResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated svyne.fees.FeeFormula formulas = 1; */
...
/**
 * @generated MessageType for protobuf message svyne.fees.ListFeeFormulasResponse
 */
...
/**
 * @generated MessageType for protobuf message svyne.fees.FeeLineItem
 */
...
class DeveloperEvent$Type extends MessageType<DeveloperEvent> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string status */ 5:
                    ...
                    break;
                case /* repeated svyne.fees.FeeLineItem items */ 6:
    ...
    internalBinaryWrite(message: DeveloperEvent, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated svyne.fees.FeeLineItem items = 6; */
...
/**
 * @generated MessageType for protobuf message svyne.fees.DeveloperEvent
 */
...
class DeveloperEventsResponse$Type extends MessageType<DeveloperEventsResponse> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: DeveloperEventsResponse): DeveloperEventsResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated svyne.fees.DeveloperEvent events */ 1:
    ...
    internalBinaryWrite(message: DeveloperEventsResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated svyne.fees.DeveloperEvent events = 1; */
...
/**
 * @generated MessageType for protobuf message svyne.fees.DeveloperEventsResponse
 */
...
/**
 * @generated MessageType for protobuf message svyne.fees.AssignFeeFormulaRequest
 */
export const AssignFeeFormulaRequest = new AssignFeeFormulaRequest$Type();
/**
 * @generated ServiceType for protobuf service svyne.fees.FeeService
 */
