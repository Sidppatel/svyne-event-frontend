...
/**
 * @generated from protobuf message ticketspan.fees.FeeFormula
 */
...
/**
 * @generated from protobuf message ticketspan.fees.FeeFormulaInput
 */
...
/**
 * @generated from protobuf message ticketspan.fees.ListFeeFormulasResponse
 */
export interface ListFeeFormulasResponse {
    /**
     * @generated from protobuf field: repeated ticketspan.fees.FeeFormula formulas = 1;
     */
    formulas: FeeFormula[];
}
/**
...
export interface DeveloperEvent {
    ...
    status: string;
    /**
     * @generated from protobuf field: repeated ticketspan.fees.FeeLineItem items = 6;
     */
    items: FeeLineItem[];
}
/**
 * @generated from protobuf message ticketspan.fees.DeveloperEventsResponse
 */
export interface DeveloperEventsResponse {
    /**
     * @generated from protobuf field: repeated ticketspan.fees.DeveloperEvent events = 1;
     */
    events: DeveloperEvent[];
}
/**
 * @generated from protobuf message ticketspan.fees.AssignFeeFormulaRequest
 */
...
class FeeFormula$Type extends MessageType<FeeFormula> {
    constructor() {
        super("ticketspan.fees.FeeFormula", [
...
/**
 * @generated MessageType for protobuf message ticketspan.fees.FeeFormula
 */
export const FeeFormula = new FeeFormula$Type();
// @generated message type with reflection information, may provide speed optimized methods
class FeeFormulaInput$Type extends MessageType<FeeFormulaInput> {
    constructor() {
        super("ticketspan.fees.FeeFormulaInput", [
...
/**
 * @generated MessageType for protobuf message ticketspan.fees.FeeFormulaInput
 */
...
class ListFeeFormulasResponse$Type extends MessageType<ListFeeFormulasResponse> {
    constructor() {
        super("ticketspan.fees.ListFeeFormulasResponse", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ListFeeFormulasResponse): ListFeeFormulasResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated ticketspan.fees.FeeFormula formulas */ 1:
    ...
    internalBinaryWrite(message: ListFeeFormulasResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated ticketspan.fees.FeeFormula formulas = 1; */
...
/**
 * @generated MessageType for protobuf message ticketspan.fees.ListFeeFormulasResponse
 */
...
class FeeLineItem$Type extends MessageType<FeeLineItem> {
    constructor() {
        super("ticketspan.fees.FeeLineItem", [
...
/**
 * @generated MessageType for protobuf message ticketspan.fees.FeeLineItem
 */
export const FeeLineItem = new FeeLineItem$Type();
// @generated message type with reflection information, may provide speed optimized methods
class DeveloperEvent$Type extends MessageType<DeveloperEvent> {
    constructor() {
        super("ticketspan.fees.DeveloperEvent", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string status */ 5:
                    ...
                    break;
                case /* repeated ticketspan.fees.FeeLineItem items */ 6:
    ...
    internalBinaryWrite(message: DeveloperEvent, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated ticketspan.fees.FeeLineItem items = 6; */
...
/**
 * @generated MessageType for protobuf message ticketspan.fees.DeveloperEvent
 */
...
class DeveloperEventsResponse$Type extends MessageType<DeveloperEventsResponse> {
    constructor() {
        super("ticketspan.fees.DeveloperEventsResponse", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: DeveloperEventsResponse): DeveloperEventsResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated ticketspan.fees.DeveloperEvent events */ 1:
    ...
    internalBinaryWrite(message: DeveloperEventsResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated ticketspan.fees.DeveloperEvent events = 1; */
...
/**
 * @generated MessageType for protobuf message ticketspan.fees.DeveloperEventsResponse
 */
...
class AssignFeeFormulaRequest$Type extends MessageType<AssignFeeFormulaRequest> {
    constructor() {
        super("ticketspan.fees.AssignFeeFormulaRequest", [
...
/**
 * @generated MessageType for protobuf message ticketspan.fees.AssignFeeFormulaRequest
 */
export const AssignFeeFormulaRequest = new AssignFeeFormulaRequest$Type();
/**
 * @generated ServiceType for protobuf service ticketspan.fees.FeeService
 */
export const FeeService = new ServiceType("ticketspan.fees.FeeService", [
