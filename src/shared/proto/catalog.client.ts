...
/**
 * @generated from protobuf service ticketspan.catalog.VenueService
 */
export interface IVenueServiceClient {
    /**
     * @generated from protobuf rpc: CreateVenue(ticketspan.catalog.CreateVenueRequest) returns (ticketspan.common.UuidValue);
     */
    createVenue(input: CreateVenueRequest, options?: RpcOptions): UnaryCall<CreateVenueRequest, UuidValue>;
    /**
     * @generated from protobuf rpc: UpdateVenue(ticketspan.catalog.UpdateVenueRequest) returns (ticketspan.common.AckResponse);
     */
    updateVenue(input: UpdateVenueRequest, options?: RpcOptions): UnaryCall<UpdateVenueRequest, AckResponse>;
    /**
     * @generated from protobuf rpc: GetVenue(ticketspan.common.UuidValue) returns (ticketspan.catalog.Venue);
     */
    getVenue(input: UuidValue, options?: RpcOptions): UnaryCall<UuidValue, Venue>;
    /**
     * @generated from protobuf rpc: ListVenues(ticketspan.common.PageRequest) returns (ticketspan.catalog.ListVenuesResponse);
     */
    listVenues(input: PageRequest, options?: RpcOptions): UnaryCall<PageRequest, ListVenuesResponse>;
    /**
     * @generated from protobuf rpc: ListVenueImages(ticketspan.common.UuidValue) returns (ticketspan.catalog.ListVenueImagesResponse);
     */
    listVenueImages(input: UuidValue, options?: RpcOptions): UnaryCall<UuidValue, ListVenueImagesResponse>;
    /**
     * @generated from protobuf rpc: AddVenueImage(ticketspan.catalog.AddVenueImageRequest) returns (ticketspan.catalog.VenueImage);
     */
    addVenueImage(input: AddVenueImageRequest, options?: RpcOptions): UnaryCall<AddVenueImageRequest, VenueImage>;
    /**
     * @generated from protobuf rpc: RemoveVenueImage(ticketspan.catalog.RemoveVenueImageRequest) returns (ticketspan.common.AckResponse);
     */
    removeVenueImage(input: RemoveVenueImageRequest, options?: RpcOptions): UnaryCall<RemoveVenueImageRequest, AckResponse>;
    /**
     * @generated from protobuf rpc: SetPrimaryVenueImage(ticketspan.catalog.RemoveVenueImageRequest) returns (ticketspan.common.AckResponse);
     */
    setPrimaryVenueImage(input: RemoveVenueImageRequest, options?: RpcOptions): UnaryCall<RemoveVenueImageRequest, AckResponse>;
    /**
     * @generated from protobuf rpc: ReorderVenueImages(ticketspan.catalog.ReorderVenueImagesRequest) returns (ticketspan.common.AckResponse);
     */
...
/**
 * @generated from protobuf service ticketspan.catalog.PerformerService
 */
export interface IPerformerServiceClient {
    /**
     * @generated from protobuf rpc: CreatePerformer(ticketspan.catalog.CreatePerformerRequest) returns (ticketspan.common.UuidValue);
     */
    createPerformer(input: CreatePerformerRequest, options?: RpcOptions): UnaryCall<CreatePerformerRequest, UuidValue>;
    /**
     * @generated from protobuf rpc: UpdatePerformer(ticketspan.catalog.UpdatePerformerRequest) returns (ticketspan.common.AckResponse);
     */
    updatePerformer(input: UpdatePerformerRequest, options?: RpcOptions): UnaryCall<UpdatePerformerRequest, AckResponse>;
    /**
     * @generated from protobuf rpc: DeletePerformer(ticketspan.common.UuidValue) returns (ticketspan.common.AckResponse);
     */
    deletePerformer(input: UuidValue, options?: RpcOptions): UnaryCall<UuidValue, AckResponse>;
    /**
     * @generated from protobuf rpc: ListPerformers(ticketspan.common.PageRequest) returns (ticketspan.catalog.ListPerformersResponse);
     */
    listPerformers(input: PageRequest, options?: RpcOptions): UnaryCall<PageRequest, ListPerformersResponse>;
    /**
     * @generated from protobuf rpc: SetEventPerformers(ticketspan.catalog.SetEventLinksRequest) returns (ticketspan.common.AckResponse);
     */
    setEventPerformers(input: SetEventLinksRequest, options?: RpcOptions): UnaryCall<SetEventLinksRequest, AckResponse>;
    /**
     * @generated from protobuf rpc: GetPerformerBySlug(ticketspan.catalog.GetBySlugRequest) returns (ticketspan.catalog.PublicPerformer);
     */
...
/**
 * @generated from protobuf service ticketspan.catalog.SponsorService
 */
export interface ISponsorServiceClient {
    /**
     * @generated from protobuf rpc: CreateSponsor(ticketspan.catalog.CreateSponsorRequest) returns (ticketspan.common.UuidValue);
     */
    createSponsor(input: CreateSponsorRequest, options?: RpcOptions): UnaryCall<CreateSponsorRequest, UuidValue>;
    /**
     * @generated from protobuf rpc: UpdateSponsor(ticketspan.catalog.UpdateSponsorRequest) returns (ticketspan.common.AckResponse);
     */
    updateSponsor(input: UpdateSponsorRequest, options?: RpcOptions): UnaryCall<UpdateSponsorRequest, AckResponse>;
    /**
     * @generated from protobuf rpc: DeleteSponsor(ticketspan.common.UuidValue) returns (ticketspan.common.AckResponse);
     */
    deleteSponsor(input: UuidValue, options?: RpcOptions): UnaryCall<UuidValue, AckResponse>;
    /**
     * @generated from protobuf rpc: ListSponsors(ticketspan.common.PageRequest) returns (ticketspan.catalog.ListSponsorsResponse);
     */
    listSponsors(input: PageRequest, options?: RpcOptions): UnaryCall<PageRequest, ListSponsorsResponse>;
    /**
     * @generated from protobuf rpc: SetEventSponsors(ticketspan.catalog.SetEventLinksRequest) returns (ticketspan.common.AckResponse);
     */
    setEventSponsors(input: SetEventLinksRequest, options?: RpcOptions): UnaryCall<SetEventLinksRequest, AckResponse>;
    /**
     * @generated from protobuf rpc: GetSponsorBySlug(ticketspan.catalog.GetBySlugRequest) returns (ticketspan.catalog.PublicSponsor);
     */
