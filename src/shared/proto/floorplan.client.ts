...
export interface IFloorPlanServiceClient {
    /**
     * @generated from protobuf rpc: SaveAsTemplate(ticketspan.floorplan.SaveAsTemplateRequest) returns (ticketspan.common.UuidValue);
     */
    saveAsTemplate(input: SaveAsTemplateRequest, options?: RpcOptions): UnaryCall<SaveAsTemplateRequest, UuidValue>;
    /**
     * @generated from protobuf rpc: ListFloorPlanTemplates(ticketspan.common.Empty) returns (ticketspan.floorplan.ListFloorPlanTemplatesResponse);
     */
    listFloorPlanTemplates(input: Empty, options?: RpcOptions): UnaryCall<Empty, ListFloorPlanTemplatesResponse>;
    /**
     * @generated from protobuf rpc: ApplyTemplate(ticketspan.floorplan.ApplyTemplateRequest) returns (ticketspan.common.AckResponse);
     */
    applyTemplate(input: ApplyTemplateRequest, options?: RpcOptions): UnaryCall<ApplyTemplateRequest, AckResponse>;
    /**
     * @generated from protobuf rpc: DeleteFloorPlanTemplate(ticketspan.common.UuidValue) returns (ticketspan.common.AckResponse);
     */
