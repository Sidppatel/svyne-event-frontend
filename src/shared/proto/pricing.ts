...
/**
 * @generated from protobuf message ticketspan.pricing.Price
 */
...
/**
 * @generated from protobuf message ticketspan.pricing.CreatePriceRequest
 */
...
/**
 * @generated from protobuf message ticketspan.pricing.UpdatePriceRequest
 */
...
export interface ListPricesResponse {
    /**
     * @generated from protobuf field: repeated ticketspan.pricing.Price prices = 1;
     */
    prices: Price[];
}
/**
 * @generated from protobuf message ticketspan.pricing.PriceRule
 */
...
export interface ListPriceRulesResponse {
    /**
     * @generated from protobuf field: repeated ticketspan.pricing.PriceRule rules = 1;
     */
    rules: PriceRule[];
}
/**
 * @generated from protobuf message ticketspan.pricing.CalculatePriceRequest
 */
...
class Price$Type extends MessageType<Price> {
    constructor() {
        super("ticketspan.pricing.Price", [
...
/**
 * @generated MessageType for protobuf message ticketspan.pricing.Price
 */
export const Price = new Price$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CreatePriceRequest$Type extends MessageType<CreatePriceRequest> {
    constructor() {
        super("ticketspan.pricing.CreatePriceRequest", [
...
/**
 * @generated MessageType for protobuf message ticketspan.pricing.CreatePriceRequest
 */
...
class UpdatePriceRequest$Type extends MessageType<UpdatePriceRequest> {
    constructor() {
        super("ticketspan.pricing.UpdatePriceRequest", [
            { no: 1, name: "prices_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
/**
 * @generated MessageType for protobuf message ticketspan.pricing.UpdatePriceRequest
 */
...
class ListPricesResponse$Type extends MessageType<ListPricesResponse> {
    constructor() {
        super("ticketspan.pricing.ListPricesResponse", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ListPricesResponse): ListPricesResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated ticketspan.pricing.Price prices */ 1:
    ...
    internalBinaryWrite(message: ListPricesResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated ticketspan.pricing.Price prices = 1; */
...
/**
 * @generated MessageType for protobuf message ticketspan.pricing.ListPricesResponse
 */
export const ListPricesResponse = new ListPricesResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class PriceRule$Type extends MessageType<PriceRule> {
    constructor() {
        super("ticketspan.pricing.PriceRule", [
...
/**
 * @generated MessageType for protobuf message ticketspan.pricing.PriceRule
 */
export const PriceRule = new PriceRule$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CreatePriceRuleRequest$Type extends MessageType<CreatePriceRuleRequest> {
    constructor() {
        super("ticketspan.pricing.CreatePriceRuleRequest", [
...
/**
 * @generated MessageType for protobuf message ticketspan.pricing.CreatePriceRuleRequest
 */
...
class UpdatePriceRuleRequest$Type extends MessageType<UpdatePriceRuleRequest> {
    constructor() {
        super("ticketspan.pricing.UpdatePriceRuleRequest", [
            { no: 1, name: "price_rules_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "rule_type", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 4, name: "priority", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
...
/**
 * @generated MessageType for protobuf message ticketspan.pricing.UpdatePriceRuleRequest
 */
...
class ListPriceRulesResponse$Type extends MessageType<ListPriceRulesResponse> {
    constructor() {
        super("ticketspan.pricing.ListPriceRulesResponse", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ListPriceRulesResponse): ListPriceRulesResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated ticketspan.pricing.PriceRule rules */ 1:
    ...
    internalBinaryWrite(message: ListPriceRulesResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated ticketspan.pricing.PriceRule rules = 1; */
...
/**
 * @generated MessageType for protobuf message ticketspan.pricing.ListPriceRulesResponse
 */
...
class CalculatePriceRequest$Type extends MessageType<CalculatePriceRequest> {
    constructor() {
        super("ticketspan.pricing.CalculatePriceRequest", [
            { no: 1, name: "prices_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
/**
 * @generated MessageType for protobuf message ticketspan.pricing.CalculatePriceRequest
 */
...
class PriceBreakdown$Type extends MessageType<PriceBreakdown> {
    constructor() {
        super("ticketspan.pricing.PriceBreakdown", [
...
/**
 * @generated MessageType for protobuf message ticketspan.pricing.PriceBreakdown
 */
...
class SetTenantDefaultFeeFormulaRequest$Type extends MessageType<SetTenantDefaultFeeFormulaRequest> {
    constructor() {
        super("ticketspan.pricing.SetTenantDefaultFeeFormulaRequest", [
...
/**
 * @generated MessageType for protobuf message ticketspan.pricing.SetTenantDefaultFeeFormulaRequest
 */
export const SetTenantDefaultFeeFormulaRequest = new SetTenantDefaultFeeFormulaRequest$Type();
/**
 * @generated ServiceType for protobuf service ticketspan.pricing.PricingService
 */
export const PricingService = new ServiceType("ticketspan.pricing.PricingService", [
