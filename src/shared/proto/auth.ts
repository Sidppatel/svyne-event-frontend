...
/**
 * @generated from protobuf message ticketspan.auth.LinkGoogleRequest
 */
...
/**
 * @generated from protobuf message ticketspan.auth.UpdateProfileRequest
 */
...
/**
 * @generated from protobuf message ticketspan.auth.LoginRequest
 */
...
/**
 * @generated from protobuf message ticketspan.auth.SignUpRequest
 */
...
/**
 * @generated from protobuf message ticketspan.auth.GoogleSignInRequest
 */
...
/**
 * @generated from protobuf message ticketspan.auth.RefreshTokenRequest
 */
...
/**
 * @generated from protobuf message ticketspan.auth.LogoutRequest
 */
...
/**
 * @generated from protobuf message ticketspan.auth.MagicLinkRequest
 */
...
/**
 * @generated from protobuf message ticketspan.auth.PasswordResetRequest
 */
...
/**
 * @generated from protobuf message ticketspan.auth.ValidateResetTokenRequest
 */
...
/**
 * @generated from protobuf message ticketspan.auth.SetPasswordRequest
 */
...
/**
 * @generated from protobuf message ticketspan.auth.AuthResponse
 */
export interface AuthResponse {
    ...
    expiresAt: string;
    /**
     * @generated from protobuf field: ticketspan.auth.UserProfile user = 4;
     */
    user?: UserProfile;
}
/**
 * @generated from protobuf message ticketspan.auth.UserProfile
 */
...
class LinkGoogleRequest$Type extends MessageType<LinkGoogleRequest> {
    constructor() {
        super("ticketspan.auth.LinkGoogleRequest", [
...
/**
 * @generated MessageType for protobuf message ticketspan.auth.LinkGoogleRequest
 */
...
class UpdateProfileRequest$Type extends MessageType<UpdateProfileRequest> {
    constructor() {
        super("ticketspan.auth.UpdateProfileRequest", [
...
/**
 * @generated MessageType for protobuf message ticketspan.auth.UpdateProfileRequest
 */
...
class SetAvatarRequest$Type extends MessageType<SetAvatarRequest> {
    constructor() {
        super("ticketspan.auth.SetAvatarRequest", [
...
/**
 * @generated MessageType for protobuf message ticketspan.auth.SetAvatarRequest
 */
export const SetAvatarRequest = new SetAvatarRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class LoginRequest$Type extends MessageType<LoginRequest> {
    constructor() {
        super("ticketspan.auth.LoginRequest", [
...
/**
 * @generated MessageType for protobuf message ticketspan.auth.LoginRequest
 */
export const LoginRequest = new LoginRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class SignUpRequest$Type extends MessageType<SignUpRequest> {
    constructor() {
        super("ticketspan.auth.SignUpRequest", [
            { no: 1, name: "email", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "password", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
/**
 * @generated MessageType for protobuf message ticketspan.auth.GoogleSignInRequest
 */
...
class RefreshTokenRequest$Type extends MessageType<RefreshTokenRequest> {
    constructor() {
        super("ticketspan.auth.RefreshTokenRequest", [
...
/**
 * @generated MessageType for protobuf message ticketspan.auth.LogoutRequest
 */
...
/**
 * @generated MessageType for protobuf message ticketspan.auth.MagicLinkRequest
 */
...
class MagicLinkVerifyRequest$Type extends MessageType<MagicLinkVerifyRequest> {
    constructor() {
        super("ticketspan.auth.MagicLinkVerifyRequest", [
...
/**
 * @generated MessageType for protobuf message ticketspan.auth.MagicLinkVerifyRequest
 */
...
class PasswordResetRequest$Type extends MessageType<PasswordResetRequest> {
    constructor() {
        super("ticketspan.auth.PasswordResetRequest", [
            { no: 1, name: "email", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "tenant_slug", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
/**
 * @generated MessageType for protobuf message ticketspan.auth.PasswordResetRequest
 */
...
class ValidateResetTokenRequest$Type extends MessageType<ValidateResetTokenRequest> {
    constructor() {
        super("ticketspan.auth.ValidateResetTokenRequest", [
            { no: 1, name: "token", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message ticketspan.auth.ValidateResetTokenRequest
 */
...
class SetPasswordRequest$Type extends MessageType<SetPasswordRequest> {
    constructor() {
        super("ticketspan.auth.SetPasswordRequest", [
            { no: 1, name: "token", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
class AuthResponse$Type extends MessageType<AuthResponse> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 expires_at */ 3:
                    ...
                    break;
                case /* ticketspan.auth.UserProfile user */ 4:
    ...
    internalBinaryWrite(message: AuthResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* ticketspan.auth.UserProfile user = 4; */
        if (message.user)
...
/**
 * @generated MessageType for protobuf message ticketspan.auth.AuthResponse
 */
export const AuthResponse = new AuthResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class UserProfile$Type extends MessageType<UserProfile> {
    constructor() {
        super("ticketspan.auth.UserProfile", [
...
/**
 * @generated MessageType for protobuf message ticketspan.auth.UserProfile
 */
export const UserProfile = new UserProfile$Type();
/**
 * @generated ServiceType for protobuf service ticketspan.auth.AuthService
 */
export const AuthService = new ServiceType("ticketspan.auth.AuthService", [
