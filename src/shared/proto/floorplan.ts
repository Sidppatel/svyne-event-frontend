...
// @generated from protobuf file "floorplan.proto" (package "ticketspan.floorplan", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message ticketspan.floorplan.SaveAsTemplateRequest
 */
...
/**
 * @generated from protobuf message ticketspan.floorplan.ApplyTemplateRequest
 */
...
/**
 * @generated from protobuf message ticketspan.floorplan.FloorPlanTemplate
 */
...
/**
 * @generated from protobuf message ticketspan.floorplan.ListFloorPlanTemplatesResponse
 */
export interface ListFloorPlanTemplatesResponse {
    /**
     * @generated from protobuf field: repeated ticketspan.floorplan.FloorPlanTemplate templates = 1;
     */
...
class SaveAsTemplateRequest$Type extends MessageType<SaveAsTemplateRequest> {
    constructor() {
        super("ticketspan.floorplan.SaveAsTemplateRequest", [
...
/**
 * @generated MessageType for protobuf message ticketspan.floorplan.SaveAsTemplateRequest
 */
...
class ApplyTemplateRequest$Type extends MessageType<ApplyTemplateRequest> {
    constructor() {
        super("ticketspan.floorplan.ApplyTemplateRequest", [
...
/**
 * @generated MessageType for protobuf message ticketspan.floorplan.ApplyTemplateRequest
 */
...
class FloorPlanTemplate$Type extends MessageType<FloorPlanTemplate> {
    constructor() {
        super("ticketspan.floorplan.FloorPlanTemplate", [
            { no: 1, name: "floor_plan_templates_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
/**
 * @generated MessageType for protobuf message ticketspan.floorplan.FloorPlanTemplate
 */
...
class ListFloorPlanTemplatesResponse$Type extends MessageType<ListFloorPlanTemplatesResponse> {
    constructor() {
        super("ticketspan.floorplan.ListFloorPlanTemplatesResponse", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ListFloorPlanTemplatesResponse): ListFloorPlanTemplatesResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated ticketspan.floorplan.FloorPlanTemplate templates */ 1:
    ...
    internalBinaryWrite(message: ListFloorPlanTemplatesResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated ticketspan.floorplan.FloorPlanTemplate templates = 1; */
...
/**
 * @generated MessageType for protobuf message ticketspan.floorplan.ListFloorPlanTemplatesResponse
 */
export const ListFloorPlanTemplatesResponse = new ListFloorPlanTemplatesResponse$Type();
/**
 * @generated ServiceType for protobuf service ticketspan.floorplan.FloorPlanService
 */
export const FloorPlanService = new ServiceType("ticketspan.floorplan.FloorPlanService", [
