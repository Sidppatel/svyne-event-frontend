...
/**
 * @generated from protobuf message svyne.floorplan.SaveAsTemplateRequest
 */
...
/**
 * @generated from protobuf message svyne.floorplan.ApplyTemplateRequest
 */
...
/**
 * @generated from protobuf message svyne.floorplan.FloorPlanTemplate
 */
...
/**
 * @generated from protobuf message svyne.floorplan.ListFloorPlanTemplatesResponse
 */
export interface ListFloorPlanTemplatesResponse {
    /**
     * @generated from protobuf field: repeated svyne.floorplan.FloorPlanTemplate templates = 1;
     */
...
/**
 * @generated MessageType for protobuf message svyne.floorplan.SaveAsTemplateRequest
 */
...
/**
 * @generated MessageType for protobuf message svyne.floorplan.ApplyTemplateRequest
 */
...
/**
 * @generated MessageType for protobuf message svyne.floorplan.FloorPlanTemplate
 */
...
class ListFloorPlanTemplatesResponse$Type extends MessageType<ListFloorPlanTemplatesResponse> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ListFloorPlanTemplatesResponse): ListFloorPlanTemplatesResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated svyne.floorplan.FloorPlanTemplate templates */ 1:
    ...
    internalBinaryWrite(message: ListFloorPlanTemplatesResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated svyne.floorplan.FloorPlanTemplate templates = 1; */
...
/**
 * @generated MessageType for protobuf message svyne.floorplan.ListFloorPlanTemplatesResponse
 */
export const ListFloorPlanTemplatesResponse = new ListFloorPlanTemplatesResponse$Type();
/**
 * @generated ServiceType for protobuf service svyne.floorplan.FloorPlanService
 */
