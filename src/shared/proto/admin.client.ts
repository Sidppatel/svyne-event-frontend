...
/**
 * @generated from protobuf service svyne.admin.DashboardService
 */
export interface IDashboardServiceClient {
    /**
     * @generated from protobuf rpc: GetAdminDashboard(svyne.common.Empty) returns (svyne.admin.AdminDashboard);
     */
    getAdminDashboard(input: Empty, options?: RpcOptions): UnaryCall<Empty, AdminDashboard>;
    /**
     * @generated from protobuf rpc: GetDeveloperDashboard(svyne.common.Empty) returns (svyne.admin.DeveloperDashboard);
     */
...
/**
 * @generated from protobuf service svyne.admin.FinancialService
 */
export interface IFinancialServiceClient {
    /**
     * @generated from protobuf rpc: GetMonthlyReport(svyne.admin.MonthlyReportRequest) returns (svyne.admin.MonthlyReport);
     */
    getMonthlyReport(input: MonthlyReportRequest, options?: RpcOptions): UnaryCall<MonthlyReportRequest, MonthlyReport>;
    /**
     * @generated from protobuf rpc: GetStripeStatus(svyne.common.UuidValue) returns (svyne.admin.StripeStatus);
     */
    getStripeStatus(input: UuidValue, options?: RpcOptions): UnaryCall<UuidValue, StripeStatus>;
    /**
     * @generated from protobuf rpc: StartStripeOnboarding(svyne.common.UuidValue) returns (svyne.admin.StripeOnboardingLink);
     */
...
export interface IStaffServiceClient {
    /**
     * @generated from protobuf rpc: ListStaffForEvent(svyne.common.UuidValue) returns (svyne.admin.ListStaffResponse);
     */
    listStaffForEvent(input: UuidValue, options?: RpcOptions): UnaryCall<UuidValue, ListStaffResponse>;
    /**
     * @generated from protobuf rpc: AssignStaff(svyne.admin.AssignStaffRequest) returns (svyne.common.AckResponse);
     */
...
/**
 * @generated from protobuf service svyne.admin.InvitationService
 */
export interface IInvitationServiceClient {
    /**
     * @generated from protobuf rpc: CreateInvitation(svyne.admin.CreateInvitationRequest) returns (svyne.common.UuidValue);
     */
    createInvitation(input: CreateInvitationRequest, options?: RpcOptions): UnaryCall<CreateInvitationRequest, UuidValue>;
    /**
     * @generated from protobuf rpc: AcceptInvitation(svyne.admin.AcceptInvitationRequest) returns (svyne.common.AckResponse);
     */
    acceptInvitation(input: AcceptInvitationRequest, options?: RpcOptions): UnaryCall<AcceptInvitationRequest, AckResponse>;
    /**
     * @generated from protobuf rpc: RevokeInvitation(svyne.common.UuidValue) returns (svyne.common.AckResponse);
     */
    revokeInvitation(input: UuidValue, options?: RpcOptions): UnaryCall<UuidValue, AckResponse>;
    /**
     * @generated from protobuf rpc: ListInvitations(svyne.common.PageRequest) returns (svyne.admin.ListInvitationsResponse);
     */
...
export interface ILogServiceClient {
    /**
     * @generated from protobuf rpc: GetAdminLogs(svyne.admin.LogQuery) returns (svyne.admin.LogPage);
     */
    getAdminLogs(input: LogQuery, options?: RpcOptions): UnaryCall<LogQuery, LogPage>;
    /**
     * @generated from protobuf rpc: GetDeveloperLogs(svyne.admin.LogQuery) returns (svyne.admin.LogPage);
     */
...
/**
 * @generated from protobuf service svyne.admin.FeedbackService
 */
export interface IFeedbackServiceClient {
    /**
     * @generated from protobuf rpc: CreateFeedback(svyne.admin.CreateFeedbackRequest) returns (svyne.common.UuidValue);
     */
    createFeedback(input: CreateFeedbackRequest, options?: RpcOptions): UnaryCall<CreateFeedbackRequest, UuidValue>;
    /**
     * @generated from protobuf rpc: ListFeedback(svyne.common.PageRequest) returns (svyne.admin.ListFeedbackResponse);
     */
    listFeedback(input: PageRequest, options?: RpcOptions): UnaryCall<PageRequest, ListFeedbackResponse>;
    /**
     * @generated from protobuf rpc: DeleteFeedback(svyne.common.UuidValue) returns (svyne.common.AckResponse);
     */
...
/**
 * @generated from protobuf service svyne.admin.HealthService
 */
export interface IHealthServiceClient {
    /**
     * @generated from protobuf rpc: Check(svyne.common.Empty) returns (svyne.admin.HealthStatus);
     */
