...
/**
 * @generated from protobuf service ticketspan.tenant.TenantService
 */
export interface ITenantServiceClient {
    /**
     * @generated from protobuf rpc: CreateTenant(ticketspan.tenant.CreateTenantRequest) returns (ticketspan.tenant.CreateTenantResponse);
     */
    createTenant(input: CreateTenantRequest, options?: RpcOptions): UnaryCall<CreateTenantRequest, CreateTenantResponse>;
    /**
     * @generated from protobuf rpc: UpdateTenant(ticketspan.tenant.UpdateTenantRequest) returns (ticketspan.common.AckResponse);
     */
    updateTenant(input: UpdateTenantRequest, options?: RpcOptions): UnaryCall<UpdateTenantRequest, AckResponse>;
    /**
     * @generated from protobuf rpc: ArchiveTenant(ticketspan.common.UuidValue) returns (ticketspan.common.AckResponse);
     */
    archiveTenant(input: UuidValue, options?: RpcOptions): UnaryCall<UuidValue, AckResponse>;
    /**
     * @generated from protobuf rpc: GetTenant(ticketspan.common.UuidValue) returns (ticketspan.tenant.Tenant);
     */
    getTenant(input: UuidValue, options?: RpcOptions): UnaryCall<UuidValue, Tenant>;
    /**
     * @generated from protobuf rpc: GetMyTenant(ticketspan.common.Empty) returns (ticketspan.tenant.Tenant);
     */
    getMyTenant(input: Empty, options?: RpcOptions): UnaryCall<Empty, Tenant>;
    /**
     * @generated from protobuf rpc: UpdateMyTenantContact(ticketspan.tenant.UpdateMyTenantContactRequest) returns (ticketspan.common.AckResponse);
     */
    ...
    /**
     * @generated from protobuf rpc: UpdateMyTenantBranding(ticketspan.tenant.UpdateMyTenantBrandingRequest) returns (ticketspan.common.AckResponse);
     */
    ...
    /**
     * @generated from protobuf rpc: GetPublicTenantBranding(ticketspan.tenant.PublicTenantBrandingRequest) returns (ticketspan.tenant.PublicTenantBranding);
     */
    ...
    /**
     * @generated from protobuf rpc: ListTenants(ticketspan.common.PageRequest) returns (ticketspan.tenant.ListTenantsResponse);
     */
    listTenants(input: PageRequest, options?: RpcOptions): UnaryCall<PageRequest, ListTenantsResponse>;
    /**
     * @generated from protobuf rpc: ListPublicTenants(ticketspan.common.Empty) returns (ticketspan.tenant.ListPublicTenantsResponse);
     */
    listPublicTenants(input: Empty, options?: RpcOptions): UnaryCall<Empty, ListPublicTenantsResponse>;
    /**
     * @generated from protobuf rpc: ListTenantMembers(ticketspan.common.UuidValue) returns (ticketspan.tenant.ListTenantMembersResponse);
     */
    listTenantMembers(input: UuidValue, options?: RpcOptions): UnaryCall<UuidValue, ListTenantMembersResponse>;
    /**
     * @generated from protobuf rpc: GetTenantStripeStatus(ticketspan.common.UuidValue) returns (ticketspan.tenant.TenantStripeStatus);
     */
    getTenantStripeStatus(input: UuidValue, options?: RpcOptions): UnaryCall<UuidValue, TenantStripeStatus>;
    /**
     * @generated from protobuf rpc: GetTenantStripeProfile(ticketspan.common.UuidValue) returns (ticketspan.tenant.TenantStripeProfile);
     */
    getTenantStripeProfile(input: UuidValue, options?: RpcOptions): UnaryCall<UuidValue, TenantStripeProfile>;
    /**
     * @generated from protobuf rpc: UpdateTenantStripeProfile(ticketspan.tenant.UpdateTenantStripeProfileRequest) returns (ticketspan.common.AckResponse);
     */
