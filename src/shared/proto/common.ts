...
class PageRequest$Type extends MessageType<PageRequest> {
    constructor() {
        super("svyne.common.PageRequest", [
            { no: 1, name: "offset", kind: "scalar", T: 5  },
...
class PageMeta$Type extends MessageType<PageMeta> {
    constructor() {
        super("svyne.common.PageMeta", [
            { no: 1, name: "total", kind: "scalar", T: 5  },
            { no: 2, name: "offset", kind: "scalar", T: 5  },
