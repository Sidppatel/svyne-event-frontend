...
// @generated from protobuf file "common.proto" (package "ticketspan.common", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message ticketspan.common.AckResponse
 */
...
/**
 * @generated from protobuf message ticketspan.common.Empty
 */
export interface Empty {
}
/**
 * @generated from protobuf message ticketspan.common.PageRequest
 */
...
/**
 * @generated from protobuf message ticketspan.common.PageMeta
 */
...
/**
 * @generated from protobuf message ticketspan.common.UuidValue
 */
...
class AckResponse$Type extends MessageType<AckResponse> {
    constructor() {
        super("ticketspan.common.AckResponse", [
...
/**
 * @generated MessageType for protobuf message ticketspan.common.AckResponse
 */
export const AckResponse = new AckResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Empty$Type extends MessageType<Empty> {
    constructor() {
        super("ticketspan.common.Empty", []);
    }
...
/**
 * @generated MessageType for protobuf message ticketspan.common.Empty
 */
export const Empty = new Empty$Type();
// @generated message type with reflection information, may provide speed optimized methods
class PageRequest$Type extends MessageType<PageRequest> {
    constructor() {
        super("ticketspan.common.PageRequest", [
...
/**
 * @generated MessageType for protobuf message ticketspan.common.PageRequest
 */
export const PageRequest = new PageRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class PageMeta$Type extends MessageType<PageMeta> {
    constructor() {
        super("ticketspan.common.PageMeta", [
...
/**
 * @generated MessageType for protobuf message ticketspan.common.PageMeta
 */
export const PageMeta = new PageMeta$Type();
// @generated message type with reflection information, may provide speed optimized methods
class UuidValue$Type extends MessageType<UuidValue> {
    constructor() {
        super("ticketspan.common.UuidValue", [
...
/**
 * @generated MessageType for protobuf message ticketspan.common.UuidValue
 */
