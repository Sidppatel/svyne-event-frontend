...
// @generated from protobuf file "enums.proto" (package "ticketspan.enums", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message ticketspan.enums.ListEnumsRequest
 */
...
/**
 * @generated from protobuf message ticketspan.enums.EnumValue
 */
...
/**
 * @generated from protobuf message ticketspan.enums.ListEnumsResponse
 */
export interface ListEnumsResponse {
    /**
     * @generated from protobuf field: repeated ticketspan.enums.EnumValue values = 1;
     */
    values: EnumValue[];
}
...
class ListEnumsRequest$Type extends MessageType<ListEnumsRequest> {
    constructor() {
        super("ticketspan.enums.ListEnumsRequest", [
...
/**
 * @generated MessageType for protobuf message ticketspan.enums.ListEnumsRequest
 */
export const ListEnumsRequest = new ListEnumsRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class EnumValue$Type extends MessageType<EnumValue> {
    constructor() {
        super("ticketspan.enums.EnumValue", [
            { no: 1, name: "enum_type", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
/**
 * @generated MessageType for protobuf message ticketspan.enums.EnumValue
 */
export const EnumValue = new EnumValue$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ListEnumsResponse$Type extends MessageType<ListEnumsResponse> {
    constructor() {
        super("ticketspan.enums.ListEnumsResponse", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ListEnumsResponse): ListEnumsResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated ticketspan.enums.EnumValue values */ 1:
    ...
    internalBinaryWrite(message: ListEnumsResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated ticketspan.enums.EnumValue values = 1; */
...
/**
 * @generated MessageType for protobuf message ticketspan.enums.ListEnumsResponse
 */
export const ListEnumsResponse = new ListEnumsResponse$Type();
/**
 * @generated ServiceType for protobuf service ticketspan.enums.EnumService
 */
export const EnumService = new ServiceType("ticketspan.enums.EnumService", [
