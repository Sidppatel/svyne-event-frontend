...
// @generated from protobuf file "enums.proto" (package "svyne.enums", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message svyne.enums.ListEnumsRequest
 */
...
/**
 * @generated from protobuf message svyne.enums.EnumValue
 */
...
/**
 * @generated from protobuf message svyne.enums.ListEnumsResponse
 */
export interface ListEnumsResponse {
    /**
     * @generated from protobuf field: repeated svyne.enums.EnumValue values = 1;
     */
    values: EnumValue[];
}
...
/**
 * @generated MessageType for protobuf message svyne.enums.ListEnumsRequest
 */
...
/**
 * @generated MessageType for protobuf message svyne.enums.EnumValue
 */
...
class ListEnumsResponse$Type extends MessageType<ListEnumsResponse> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ListEnumsResponse): ListEnumsResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated svyne.enums.EnumValue values */ 1:
    ...
    internalBinaryWrite(message: ListEnumsResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated svyne.enums.EnumValue values = 1; */
...
/**
 * @generated MessageType for protobuf message svyne.enums.ListEnumsResponse
 */
export const ListEnumsResponse = new ListEnumsResponse$Type();
/**
 * @generated ServiceType for protobuf service svyne.enums.EnumService
 */
