...
function TicketCard({ cardRef }: { cardRef: React.Ref<HTMLDivElement> }) {
  return (
    <div
      ref={cardRef}
      className="ticketspan-tilt w-full rotate-2 overflow-hidden rounded-xl bg-surface shadow-[var(--shadow-e2)] motion-reduce:rotate-0"
    >
      ...
      <div className="ticketspan-ticket-edge" style={{ ['--ticketspan-notch' as string]: 'var(--stage)' }} />
          ...
          return (
            <div
              ...
              className={cn(
                ...
                isHeld && 'ticketspan-hold-pulse bg-voltage text-voltage-ink shadow-[var(--shadow-e1)]',
              )}
            >
              {table.label}
            </div>
    ...
    <div className="overflow-hidden rounded-xl border border-hairline bg-surface shadow-[var(--shadow-e1)]">
      <div className="flex items-center justify-between border-b border-hairline px-5 py-3">
        ...
        <span className="flex items-center gap-1.5 font-mono text-[11px] text-success">
          <span className="ticketspan-urgent h-1.5 w-1.5 rounded-full bg-success" /> On sale
        </span>
      </div>
...
export function ScannerMock() {
  return (
    <div className="mx-auto w-full max-w-[240px] overflow-hidden rounded-[24px] border-4 border-stage-elevated bg-stage shadow-[var(--shadow-e1)] select-none">
      ...
      <div className="ticketspan-scanline px-4 py-8 text-center text-success">
