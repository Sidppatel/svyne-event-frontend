...
const NOTCH = { ['--ticketspan-notch' as string]: 'var(--surface)' } as CSSProperties;

export function EventCard({ event, index }: { event: Event; index: number }) {
  return (
    <Link
      to={`/events/${event.slug}`}
      className="ticketspan-page group rounded-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
    ...
    >
      <Card interactive className="flex h-full flex-col overflow-hidden">
        ...
        <div className="ticketspan-ticket-edge mx-5" style={NOTCH} />
