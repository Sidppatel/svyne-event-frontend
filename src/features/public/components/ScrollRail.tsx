...
export function ScrollRail({
  ...
  const arrowBase =
    'absolute top-1/2 z-10 hidden md:grid size-10 -translate-y-1/2 place-items-center rounded-full border backdrop-blur transition disabled:pointer-events-none disabled:opacity-0';
