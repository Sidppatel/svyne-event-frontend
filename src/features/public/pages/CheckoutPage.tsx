      ...
      <div className="grid grid-cols-1 items-start gap-8 lg:grid-cols-12">
        <div className="space-y-6 lg:col-span-5">
          <div className="overflow-hidden rounded-lg border border-hairline bg-surface shadow-[var(--shadow-e1)]">
            ...
            <div className="ticketspan-ticket-edge" style={NOTCH} />
      ...
      <CardContent className="space-y-6 p-6">
        {secondsLeft !== null && !expired ? (
          <div
            className={
              urgent
                ? 'ticketspan-urgent flex items-center gap-2 rounded-md border border-warning/30 bg-warning/10 px-4 py-3 text-sm font-medium text-warning'
