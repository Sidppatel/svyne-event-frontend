  ...
  return (
    <div className="grid min-h-screen grid-cols-1 lg:grid-cols-[1.1fr_1fr]">
      <aside className="relative hidden overflow-hidden bg-stage p-12 text-on-stage lg:flex lg:flex-col lg:justify-between">
        ...
        <span className="relative font-display text-2xl font-semibold tracking-tight text-on-stage">ticketspan</span>
      ...
      <main className="flex items-center justify-center px-6 py-12 sm:px-10">
        <div ref={panel} className="w-full max-w-sm">
          <div className="mb-8 lg:hidden">
            <span className="font-display text-2xl font-semibold tracking-tight text-brand">ticketspan</span>
          </div>
          {children}
        </div>
      </main>
