...
export function AdminTableTypesPage() {
  ...
  return (
    <div className="space-y-8 max-w-5xl mx-auto py-2">
      ...
      { }
      <div
        className="ticketspan-float-card border border-border bg-card shadow-xl rounded-2xl overflow-hidden transition-all duration-300"
      >
        ...
        <CardContent className="p-6 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-t border-border/20 pt-4">
            ...
            <Button
              ...
              disabled={!name.trim()}
              className={cn(
                "ticketspan-spring-btn h-11 px-8 rounded-xl font-bold uppercase tracking-wider text-xs shadow-md shadow-primary/20",
          ...
          <div className="overflow-hidden space-y-4 pt-2.5">
            ...
            <div className="flex items-center justify-between gap-3 border-t border-border/10 pt-3">
              ...
              <Button
                ...
                size="sm"
                className="ticketspan-spring-btn h-9 px-6 rounded-lg font-bold text-xs"
              >
                Save Settings
              </Button>
            </div>
