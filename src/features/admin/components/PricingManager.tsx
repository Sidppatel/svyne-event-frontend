  ...
  return (
    <Card className="border border-border bg-card shadow-sm rounded-2xl overflow-hidden">
      <CardHeader className="border-b border-border/20 px-6 py-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <Button size="sm" onClick={() => setRuleBuilderOpen(true)} disabled={noApplicablePrices || ruleBuilderOpen} className="ticketspan-spring-btn h-9 px-4 rounded-lg font-bold text-xs">
  ...
  return (
    <div className="space-y-1.5 py-1.5 border-b border-border/30 last:border-0">
      <div className="flex items-center gap-4 text-sm bg-muted/10 p-3 rounded-xl border border-border/30">
        ...
        <div className="relative w-28 ticketspan-spring-input">
        ...
        <Button
          size="sm"
          className={cn("h-9 px-4 rounded-lg font-bold text-xs", dirty ? "ticketspan-spring-btn shadow-md shadow-primary/20" : "")}
    ...
    <div className="rounded-xl border border-border/50 bg-muted/10 p-5 space-y-5 animate-in fade-in slide-in-from-top-2 duration-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-1.5">
          ...
          <div className="ticketspan-spring-input relative">
            <Input
              type="number"
              min={0}
              max={100}
      ...
      <div className="flex justify-end gap-3 pt-2">
        ...
        <Button onClick={submit} disabled={busy || !name.trim()} className="ticketspan-spring-btn h-9 px-6 rounded-lg font-bold text-xs shadow-sm">
