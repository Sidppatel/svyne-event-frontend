    ...
    <div className="space-y-6">
      ...
      {loading || !data ? (
        ...
        <>
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            <Card>
              <CardContent className="py-4">
                <p className="text-xs uppercase tracking-wide text-muted-foreground">TicketSpan must remit</p>
          ...
          <RemittanceSection
            title="Tax to remit — collected by TicketSpan"
            description="Tax collected on the platform account. TicketSpan pays these amounts to the tax authorities each month."
            months={data.platformMonths}
            csvName="tax-remittance-platform.csv"
          />

          <RemittanceSection
            title="Tenant-collected tax — not remitted by TicketSpan"
